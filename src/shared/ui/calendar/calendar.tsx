  ...
  return (
    <DayPicker
      ...
      className={cn(
        ...
        [--cell-size:--spacing(8)] in-data-[slot=card-content]:bg-transparent
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ...
            : `cn-calendar-caption-label flex items-center gap-1
              rounded-(--cell-radius) text-sm [&>svg]:size-3.5
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        dark:hover:text-foreground relative isolate z-10 flex aspect-square
        size-auto w-full min-w-(--cell-size) flex-col gap-1 border-0
        ...
        data-[range-start=true]:rounded-l-(--cell-radius) [&>span]:text-xs
        [&>span]:opacity-70`,
        defaultClassNames.day,
        className
      )}
