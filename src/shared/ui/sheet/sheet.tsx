  ...
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        ...
        data-open:fade-in-0 fixed inset-0 z-50 bg-black/10 duration-100
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          `bg-background data-open:animate-in data-open:fade-in-0
          ...
          data-[side=top]:data-closed:slide-out-to-top-10 fixed z-50 flex
          flex-col gap-4 bg-clip-padding text-sm shadow-lg transition
...
/** Accessible heading for the sheet content. */
...
/** Accessible description text displayed below the sheet title. */
