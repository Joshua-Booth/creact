...
function CommandSeparator({
  ...
  // Override role to avoid aria-required-children violation
  // (listbox cannot contain role="separator")
  // Using the primitive preserves cmdk's alwaysRender behavior
  return (
