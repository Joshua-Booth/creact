    ...
    <NavigationMenuPrimitive.Portal>
      ...
      >
        <NavigationMenuPrimitive.Popup
          className="data-[ending-style]:easing-[ease] xs:w-(--popup-width)
            bg-popover text-popover-foreground ring-foreground/10 relative
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        ...
        data-[active=true]:focus:bg-muted flex items-center gap-1.5 rounded-md
  ...
  return (
    <NavigationMenuPrimitive.Icon
      ...
      className={cn(
        ...
        data-[state=visible]:animate-in data-[state=visible]:fade-in top-full
    ...
    >
      <div
        className="bg-border relative top-[60%] size-2 rotate-45 rounded-tl-sm
          shadow-md"
      />
    </NavigationMenuPrimitive.Icon>
  );
