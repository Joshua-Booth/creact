...
/** Style variants for the {@link Bubble} component. */
const bubbleVariants = cva(
  ...
  data-[variant=ghost]:max-w-full`,
  {
    variants: {
      variant: {
        default: `*:data-[slot=bubble-content]:bg-primary
        ...
        *:data-[slot=bubble-content]:text-foreground
        ...
        outline: `*:data-[slot=bubble-content]:border-border
        *:data-[slot=bubble-content]:bg-background
        ...
        ghost: `border-none *:data-[slot=bubble-content]:rounded-none
        ...
        *:data-[slot=bubble-content]:p-0
        ...
        destructive: `*:data-[slot=bubble-content]:bg-destructive/10
 ...
 * styles.
 * @see {@link bubbleVariants} for available variant options
 */
function Bubble({
  variant = "default",
  align = "start",
...
/** Padded, rounded content area of a bubble; renders as any element via `render`. */
    ...
    props: mergeProps<"div">(
      {
        className: cn(
          ...
          border-transparent px-3 py-2 text-sm/relaxed wrap-break-word
...
/** Style variants for the {@link BubbleReactions} component. */
...
/** Floating reaction badge pinned to a corner of a bubble. */
