...
function FieldSet({ className, ...props }: FieldsetPrimitive.Root.Props) {
  return (
    <FieldsetPrimitive.Root
      data-slot="field-set"
      className={cn(
        `flex flex-col gap-6 has-[>[data-slot=checkbox-group]]:gap-3 has-[>[data-slot=radio-group]]:gap-3 has-[>[data-variant=label]]:gap-3`,
        className
      )}
      {...props}
    />
 ...
 * Use {@link FieldDescription} inside Field for proper aria-describedby association.
 */
function FieldLegendDescription({
  ...
  return (
    <p
      ...
      className={cn(
        `mb-3 text-left text-sm/normal font-normal text-muted-foreground [[data-variant=label]+&]:-mt-4 [[data-variant=legend]+&]:-mt-8`,
...
/** Style variants for the {@link Field} component. */
...
function FieldLabel({ className, ...props }: FieldPrimitive.Label.Props) {
  return (
    <FieldPrimitive.Label
      ...
      className={cn(
        `group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:border-primary/50 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-3 dark:has-data-checked:bg-primary/10`,
...
function FieldDescription({
  ...
  return (
    <FieldPrimitive.Description
      ...
      className={cn(
        `text-left text-sm/normal font-normal text-muted-foreground group-has-data-[orientation=horizontal]/field:text-balance`,
...
/**
 * Error message that works both inside and outside Field context.
 * Inside Field, provides aria-describedby association; standalone, renders with role="alert".
 */
function FieldError({
  className,
  children,
