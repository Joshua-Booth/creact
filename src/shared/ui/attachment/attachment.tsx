...
/** Style variants for the {@link Attachment} component. */
 ...
 * @see {@link attachmentVariants} for available size/orientation options
 */
function Attachment({
  className,
  state = "done",
...
/** Style variants for the {@link AttachmentMedia} component. */
...
/** Icon or image thumbnail area of an attachment. */
...
/** Text content area of an attachment, holding title and description. */
...
/** File name of an attachment; shimmers while uploading or processing. */
  ...
  return (
    <span
      ...
      className={cn(
        ...
        group-data-[state=uploading]/attachment:shimmer block max-w-full min-w-0
...
/** Secondary detail line of an attachment, such as file size or status. */
  ...
  return (
    <span
      ...
      className={cn(
        ...
        group-data-[state=error]/attachment:text-destructive/80 mt-0.5 block
...
/** Container for action buttons on an attachment. */
...
/** Single action button on an attachment, such as remove or download. */
...
/** Invisible overlay that makes the whole attachment clickable; renders as any element via `render`. */
...
/** Horizontally scrollable row of attachments with snap points. */
