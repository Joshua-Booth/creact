      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(
            ...
            data-closed:fade-out-0 data-closed:zoom-out-95 relative isolate z-50
            max-h-(--available-height) w-(--anchor-width) min-w-36
            origin-(--transform-origin) overflow-x-hidden overflow-y-auto
            rounded-md shadow-md ring-1 duration-100
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        flex w-full cursor-default items-center gap-2 rounded-sm py-1.5 pr-8
