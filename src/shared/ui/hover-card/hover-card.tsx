...
/** Element that triggers the hover card when hovered. */
      ...
      >
        <PreviewCardPrimitive.Popup
          ...
          className={cn(
            ...
            data-closed:fade-out-0 data-closed:zoom-out-95 z-50 w-64
            origin-(--transform-origin) rounded-lg p-4 text-sm shadow-md ring-1
